...
>- 于雨氏，2018/02/11，于海淀添加 <a href="#5">[5 Router群集]</a> 一章节，并重新格式化全文。
>- 于雨氏，2018/03/05，于海淀添加 <a href="#6">[6 离线消息]</a> 一章节。
>- 于雨氏，2018/03/14，于海淀添加负反馈机制、根据Gateway Message ID保证Gateway Message数据一致性 和 Gateway用户退出消息产生机制 等三个细节。
>- 于雨氏，2018/08/05，于海淀添加 <a href="#2.2.1">[2.2.1 pipeline]</a> 一节。
>- 于雨氏，2018/08/28，于海淀添加 <a href="#2.2.2">[2.2.2 大房间消息处理]</a> 一节。
>- 于雨氏，2019/01/19，于丰台添加 <a href="#7">[7 单聊消息]</a> 一章节。
>- 于雨氏，2019/06/08，于丰台添加 <a href="#0">[0 实时消息系统与消息队列系统]</a> 一章节。
