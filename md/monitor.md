...
Monitor 系统完成上线后，服务端同事们仅仅使用了 Dashboard 而抛弃了 Alarm，有同事嫌弃设置参数太麻烦，需不断调整，而且即便收到告警也可能及时处理，因为会影响其休息。这个一方面原因是工程师素质确实不高，对服务质量确实不够关心，习惯于重启大法，另一方面也确实说明了系统的智能化水平有待提高。
